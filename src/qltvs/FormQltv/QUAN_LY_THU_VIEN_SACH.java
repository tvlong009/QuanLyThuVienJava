...
public class QUAN_LY_THU_VIEN_SACH extends javax.swing.JFrame {
    ...
    public QUAN_LY_THU_VIEN_SACH(String currentUserRole) {
        initComponents();
    
        CurrentUserRole = currentUserRole;
        System.out.println("Ok " + CurrentUserRole);
        if(CurrentUserRole.equals("user")){
            jPanel1.remove(btnQlm);
        } 
    ...
    private void btnQlsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQlsActionPerformed
       ...
       if(m!=JOptionPane.YES_OPTION){
        ...
        Quan_Ly_Sach ql = new Quan_Ly_Sach(CurrentUserRole);
        ql.setVisible(true);
        this.dispose();
    ...
    private void btnQlmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQlmActionPerformed
        ...
        Quan_Ly_Muon_Tra ql1=new Quan_Ly_Muon_Tra(CurrentUserRole);
        ql1.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QUAN_LY_THU_VIEN_SACH(CurrentUserRole).setVisible(true);
            }
        });
    }
